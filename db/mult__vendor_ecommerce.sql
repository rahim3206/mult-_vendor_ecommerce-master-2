...
--
-- Host: localhost:3306
-- Generation Time: Mar 28, 2024 at 07:56 PM
...
--
-- Database: `mult__vendor_ecommerce`
--
...
(1, 'Ad', 'Min', NULL, NULL, NULL, NULL, 'admin@gmail.com', '$2y$10$1Tvj4bW2wz7qZYG./uO7FuLJB.Y/yFODWpOBb1sQrWtSScU5XzNJy', NULL, NULL, NULL);
...
(1, 'Mens', '2024-03-28 13:33:31', '2024-03-28 13:33:31'),
(2, 'Womens', '2024-03-28 14:13:27', '2024-03-28 14:13:27');
...
CREATE TABLE `generals` (
  ...
  `site_city` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `site_state` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `site_postal_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `products` (`id`, `title`, `image`, `description`, `price`, `quantity`, `status`, `meta_title`, `meta_description`, `meta_keywords`, `category_id`, `sub_category_id`, `vendor_id`, `created_at`, `updated_at`) VALUES
(1, 'g', '1658553653.BUILT WORDPRESS WEBSITE OR  LANDING PAGE.png', '<p>fghf</p>', 6, 5, '1', NULL, NULL, NULL, 1, 1, 1, '2024-03-28 14:44:35', '2024-03-28 14:44:35');
...
CREATE TABLE `smtp_setups` (
  ...
  `smtp_transport` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Shirts', 1, '2024-03-28 13:34:03', '2024-03-28 13:34:03'),
(2, 'Pents', 1, '2024-03-28 13:34:03', '2024-03-28 13:34:03'),
(3, 'Shorts', 1, '2024-03-28 13:34:03', '2024-03-28 13:34:03');
