                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <div>
                                <a class="btn btn-primary btn-sm" href="{{ route('admin.sub_categories.create') }}"> <i class="fa fa-plus"></i> Add Sub Category</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sub_categories as $sub_category)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $sub_category->category->title }}</p>
                                            </td>
                                            <td class="align-middle d-flex">
                                                <a href="{{ route('admin.sub_categories.edit', $sub_category->id) }}" class="btn text-secondary font-weight-bold text-xs"
